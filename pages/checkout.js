                                            ...
                                            <tbody>
                                                <tr>
                                                    <td className="product-name">
                                                        <Link href="/product-details"><a>Note Book Mockup</a></Link>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="product-name">
                                                        <Link href="/product-details"><a>Motivational Book Cover</a></Link>
                                                    </td>
                                                    <td className="product-total">
                                                ...
                                                <tr>
                                                    <td className="product-name">
                                                        <Link href="/product-details"><a>Book Cover Softcover</a></Link>
                                                    </td>
                                                    <td className="product-total">
                                                        <span className="subtotal-amount">$200.00</span>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td className="product-name">
                                                        <Link href="/product-details"><a>Stop and Take a Second</a></Link>
                                                    </td>
                                                    <td className="product-total">
