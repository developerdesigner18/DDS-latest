                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6">
                            <div className="faq-item">
                                ...
                                <p>
                                    <strong>A:</strong> Digital marketing
                                    involves marketing to people using
                                    Internet-connected electronic devices,
                                    namely computers, smartphones and tablets.
                                    Digital marketing focuses on channels such
                                    as search engines, social media, email,
                                    websites and apps to connect with prospects
                                    and customers.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="faq-item">
                                <h3>
                                    Q: Would my business benefit from digital
                                    marketing?
                                </h3>
                                <p>
                                    <strong>A:</strong> Digital marketing
                        ...
                        <div className="col-lg-6 col-md-6">
                            <div className="faq-item">
                                <h3>
                                    Q: What’s the biggest mistake digital
                                    marketers make?
                                </h3>
                                <p>
                                    <strong>A:</strong> Digital marketing
